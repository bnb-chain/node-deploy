...
#sed -i 's/18000000/1800/g'  /server/validator/chaind.sh
#sed -i 's/ --override.pascal 1747481702  --override.prague 1747481702 /  /g'  /server/validator/chaind.sh
#sed -i 's/--override.lorentz / --override.pascal 1748515525  --override.prague 1748515525 --override.lorentz /g'  /server/validator/chaind.sh
